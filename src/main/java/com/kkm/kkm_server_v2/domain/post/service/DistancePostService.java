...
public class DistancePostService {
    ...
    @Transactional
    public PostListResponse execute(int page, int size, int distance) {
        ...
        Page<Post> list = postRepository.findByDistance(location.getLongitude(), location.getLatitude(), distance, pageable);
